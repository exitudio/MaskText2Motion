...
def evaluate_multimodality(mm_motion_loaders, file, mm_num_times, eval_wrapper):
    eval_dict = OrderedDict({})
...
def evaluation(log_file, gt_loader, eval_wrapper, eval_motion_loaders, mm_num_times, diversity_times):
    replication_times = 1
    with open(log_file, 'w') as f:
        ...
        for replication in range(replication_times):
            ...
            print(f'Time: {datetime.now()}')
            print(f'Time: {datetime.now()}', file=f, flush=True)
            mm_score_dict = evaluate_multimodality(mm_motion_loaders, f, mm_num_times, eval_wrapper)
...
if __name__ == '__main__':
    ...
    evaluation(log_file, gt_loader, eval_wrapper, eval_motion_loaders, mm_num_times, diversity_times)