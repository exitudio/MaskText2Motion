#!/bin/sh
# cd /users/epinyoan/git/MaskText2Motion/MotionDiffuse/text2motion/mask_model/experiments/
# sbatch train_transformer.sh
# screen -S temp ~/git/MaskText2Motion/MotionDiffuse/text2motion/mask_model/experiments/train_transformer.sh
