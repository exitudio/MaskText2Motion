...
# screen -L -Logfile EvalEDIT_HML3D_44_crsAtt1lyr_mask0.5-1_20bRest_2_rpeat1_notxt /home/epinyoan/git/MaskText2Motion/MMM2/experiments/eval_edit.sh
...
python3 eval_edit.py  \
    ...
    --vq-act relu \
    --resume-trans /home/epinyoan/git/MaskText2Motion/MMM2/output/t2m/2023-10-15-09-13-42_HML3D_46_crsAtt1lyr_20breset_.1DrpTxt/net_last.pth
sleep 500