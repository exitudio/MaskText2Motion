...
# screen -L -Logfile HML3D_29_endInput_noEndOutput -S temp ~/git/MaskText2Motion/T2M-BD/experiments/train_trans.sh

#SBATCH --job-name=HML3D_29_endInput_noEndOutput
...
name='HML3D_29_endInput_noEndOutput' # TEMP
dataset_name='t2m'
