...
# screen -L -Logfile HML3D_43_upperEdit_transMaskLower_randLen_moveUpperDown -S temp ~/git/MaskText2Motion/T2M-BD/experiments/train_trans_uplow.sh

#SBATCH --job-name=HML3D_43_upperEdit_transMaskLower_randLen_moveUpperDown
