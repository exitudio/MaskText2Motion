...
class Text2MotionDataset(data.Dataset):
    def __init__(self, dataset_name, feat_bias = 5, unit_length = 4, codebook_size = 1024, tokenizer_name=None):
        ...
        self.mot_pad_idx = codebook_size # [TODO] I think 513 (codebook_size+1) can be what ever, it will be croped out
        if dataset_name == 't2m':
            ...
            radius = 4
            fps = 20
            self.max_motion_length = 26 if unit_length == 8 else 49
            dim_pose = 263
