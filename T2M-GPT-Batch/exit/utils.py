...
def init_save_folder(args):
    ...
    if args.exp_name != 'TEMP':
        ...
        for f in  glob.glob('dataset/dataset*.py')+['bidirec_autoregress', 'exit', 'experiments', 'models', 'options', 'utils', 'GPT_eval_multi.py', 'train_t2m_trans.py', 'train_vq.py', 'VQ_eval.py', 'train_bidirec_autoregress.py']:
            try:
